...
export default function AIEscrowGuard({
 ...
 <span className="font-bold text-red-400"> AI Escrow Guard: Validation Failed</span>
 ...
 <span className="font-bold text-emerald-400"> AI Escrow Guard</span>
 ...
 Validation Failed: Document Mismatch
 </div>
 ) : (
 <>
