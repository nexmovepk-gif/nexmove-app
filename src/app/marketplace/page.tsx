...
import { Heart, SlidersHorizontal, RotateCcw, Building2, Home, Search, ShieldCheck } from 'lucide-react';
...
export default function MarketplacePage() {
 ...
 <span className="text-xs text-emerald-700 font-bold flex items-center gap-1"><ShieldCheck className="w-3.5 h-3.5" /> Live Escrow Protection Active</span>
 </div>
