...
export default function ListingDetailClient({ listing }: { listing: PublicListingItem }) {
 ...
 <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.955 11.955 0 01.27 14.33c-.14.63-.1.27 0 .13c.7 3.273 2.82 6.05 5.73 7.69 2.91 1.64 6.42 1.79 9.47.4a12 12 0 006.09-7.08c.21-.65.38-1.31.51-1.99" /></svg>
 </div>
 <div>
